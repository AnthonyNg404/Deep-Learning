...
class MLPPolicySL(MLPPolicy):
    ...
    def update(
        ...
        loss = torch.mean(-self(observations).log_prob(actions))
...
class MLPPolicyPG(MLPPolicy):
    ...
    def update(self, observations, acs_na, adv_n=None, acs_labels_na=None,
        ...
        loss = torch.mean(-self(observations).log_prob(actions) * adv_n)
        ...
        if self.nn_baseline:
            ...
            baselines_n = torch.squeeze(self.baseline(observations))      
            baseline_loss = self.baseline_loss(baselines_n, targets_n)
...
class MLPPolicyAC(MLPPolicy):
    ...
    def update(self, observations, critic):
        ...
        loss = -critic(observations, actions)
